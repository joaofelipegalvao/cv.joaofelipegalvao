...
#let tw = (
  ...
  section-header: "flex items-center gap-3 text-lg font-semibold uppercase tracking-wide text-indigo-600 dark:text-indigo-400 pb-2.5 border-b border-zinc-200 dark:border-zinc-700",
)
